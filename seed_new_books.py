...
from app.models.new_books import NewBookSection, NewCategory, NewCategoryBook, NewBook

print(db)

def seed_new_books():
    NewBookSection.create('Must Read')
    ...
    for i in range(len(books)): 
        ...
        # new_category_book = NewCategoryBook.query.filter_by(category_id=category.id, book_id=added_book.id).first()
        # new_category_book.section_id = 1
        # db.session.commit()
